...
export const AUDIO_TRACK_MAP: Record<string, any> = {
  ...
  "Michael Shynes - Next to You.mp3": require("../../assets/music/Michael Shynes - Next to You.mp3"),
  "messwave - needed you.mp3": require("../../assets/music/messwave - needed you.mp3"),
  "Logan Pilcher - Answers to Questions.mp3": require("../../assets/music/Logan Pilcher - Answers to Questions.mp3"),
  "LANI - COPYPASTE feat JARED.mp3": require("../../assets/music/LANI - COPYPASTE feat JARED.mp3"),
  "L Donner - Singela feat Soraya Ravenle.mp3": require("../../assets/music/L Donner - Singela feat Soraya Ravenle.mp3"),
  "Katrina Stone - Dont Tell Me What to Do.mp3": require("../../assets/music/Katrina Stone - Dont Tell Me What to Do.mp3"),
  "Jimmy Curtis - On Top.mp3": require("../../assets/music/Jimmy Curtis - On Top.mp3"),
  "Jay Sanon - Come My Way.mp3": require("../../assets/music/Jay Sanon - Come My Way.mp3"),
  "Jane  The Boy - Wild.mp3": require("../../assets/music/Jane  The Boy - Wild.mp3"),
  "Jane  The Boy - Hostage.mp3": require("../../assets/music/Jane  The Boy - Hostage.mp3"),
  "Henry Young - One More Last Time feat Ashley Alisha.mp3": require("../../assets/music/Henry Young - One More Last Time feat Ashley Alisha.mp3"),
  "Ge Filter Fish - Baby Im Stuck in a Cone.mp3": require("../../assets/music/Ge Filter Fish - Baby Im Stuck in a Cone.mp3"),
  "FVMELESS - First Name Basis.mp3": require("../../assets/music/FVMELESS - First Name Basis.mp3"),
  "Frank Bentley - TUNNEL VISION.mp3": require("../../assets/music/Frank Bentley - TUNNEL VISION.mp3"),
  "Echo LaRoux - Take My Heart and Go.mp3": require("../../assets/music/Echo LaRoux - Take My Heart and Go.mp3"),
  "Donner  Tie - Gostosinho.mp3": require("../../assets/music/Donner  Tie - Gostosinho.mp3"),
  "djnoone - Ojitos.mp3": require("../../assets/music/djnoone - Ojitos.mp3"),
  "Dimitrix - Fun Fun Fun.mp3": require("../../assets/music/Dimitrix - Fun Fun Fun.mp3"),
  "Curtis Cole - BOO.mp3": require("../../assets/music/Curtis Cole - BOO.mp3"),
  "Christopher Galovan - Aire.mp3": require("../../assets/music/Christopher Galovan - Aire.mp3"),
  "Captain Joz - King Bayla.mp3": require("../../assets/music/Captain Joz - King Bayla.mp3"),
  "Birraj - Prelude in E Minor Op 28 No 4.mp3": require("../../assets/music/Birraj - Prelude in E Minor Op 28 No 4.mp3"),
  "Birraj - Nocturne in Eb Op 9 No 2.mp3": require("../../assets/music/Birraj - Nocturne in Eb Op 9 No 2.mp3"),
  "Anthony Lazaro - A Thousand Little Fires.mp3": require("../../assets/music/Anthony Lazaro - A Thousand Little Fires.mp3"),
  "Amos Ever Hadani - Infinito Tren.mp3": require("../../assets/music/Amos Ever Hadani - Infinito Tren.mp3"),
  "Amick Cutler - Weight of My Love.mp3": require("../../assets/music/Amick Cutler - Weight of My Love.mp3"),
};
